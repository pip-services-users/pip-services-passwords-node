...
class PasswordsServiceFactory extends pip_services_components_node_1.Factory {
    constructor() {
        super();
...
PasswordsServiceFactory.Descriptor = new pip_services_commons_node_1.Descriptor("pip-services-passwords", "factory", "default", "default", "1.0");
PasswordsServiceFactory.MemoryPersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-passwords", "persistence", "memory", "*", "1.0");
PasswordsServiceFactory.FilePersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-passwords", "persistence", "file", "*", "1.0");
PasswordsServiceFactory.MongoDbPersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-passwords", "persistence", "mongodb", "*", "1.0");
PasswordsServiceFactory.ControllerDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-passwords", "controller", "default", "*", "1.0");
PasswordsServiceFactory.SenecaServiceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-passwords", "service", "seneca", "*", "1.0");
PasswordsServiceFactory.HttpServiceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-passwords", "service", "http", "*", "1.0");
